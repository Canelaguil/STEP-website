<div class="row z-depth-3 containedrow ">
    <div class="hero-image ">
        <div class="hero-text z-depth-2">
            <h1>Ravel, Venema, Beethoven, Moari, Van Bree</h1>
            <h3>3 juli 20:15, Den Bosch</h3>
            <a href="/muziek" target="__blank" class='waves-effect waves-light btn btnred'>Meer informatie</a>
        </div>
