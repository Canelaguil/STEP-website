<div class="row z-depth-3 containedrow ">
    <div class="hero-image ">
        <div class="hero-text z-depth-2">
            <h1>STEP zoekt componisten! // STEP is looking for composers! </h1>
            <a href="/componisten" target="__blank" class='waves-effect waves-light btn btnred'>Meer informatie</a>
        </div>
