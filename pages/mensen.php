    ...
    <div class="col m4 s12">
        <div class="card">
            <div class="cardimage waves-effect waves-block waves-light">
                <img class="activator" src="../img/mensen/wouter.png">
            </div>
            <div class="card-content cardfunctie">
                <span class="card-title activator">Wouter Booij</span>
...
<div class="row hometext">
    ...
    <div class="col s12 m6">
        <div class="card">
            <div class="card-image flipsjoerdimg activator">
                <img class="activator" src="../img/mensen/Sjoerd.jpeg">
                <span class="card-title">Dirigent</span>
            </div>
            <div class="card-content spcontent activator">
                <p class="activator"> Sjoerd Haver <i class="material-icons">chevron_right</i></p>
            </div>
            <div class="card-reveal cardtextact">
    ...
    <div class="col s12 m6">
        <div class="card">
            <div class="card-image flipsjoerdimg">
                <img class="activator" src="../img/mensen/philip.jpeg">
                <span class="card-title">Huiscomponist</span>
            </div>
            <div class="card-content spcontent activator">
                <p>Philip Venema <i class="material-icons">chevron_right</i></p>
            </div>
            <div class="card-reveal cardtextact">
